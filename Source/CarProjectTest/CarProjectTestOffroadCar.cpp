...
#include "CarProjectTestOffroadCar.h"
#include "CarProjectTestOffroadWheelFront.h"
#include "CarProjectTestOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACarProjectTestOffroadCar::ACarProjectTestOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarProjectTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarProjectTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarProjectTestOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarProjectTestOffroadWheelRear::StaticClass();
