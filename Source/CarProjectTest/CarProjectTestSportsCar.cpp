...
#include "CarProjectTestSportsCar.h"
#include "CarProjectTestSportsWheelFront.h"
#include "CarProjectTestSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarProjectTestSportsCar::ACarProjectTestSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarProjectTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarProjectTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarProjectTestSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarProjectTestSportsWheelRear::StaticClass();
